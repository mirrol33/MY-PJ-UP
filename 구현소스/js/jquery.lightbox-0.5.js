...
(function ($) {
  ...
  $.fn.lightBox = function (settings) {
    ...
    function _resize_container_image_box(
      ...
      var intWidth =
        intImageWidth + settings.containerBorderSize * 2; // Plus the image�s width and the left and right padding value
      var intHeight =
        intImageHeight + settings.containerBorderSize * 2; // Plus the image�s height and the left and right padding value
      // Diferences
    ...
    function _show_image_data() {
      $("#lightbox-container-image-data-box").slideDown(
        "fast"
      );
    ...
    function _preload_neighbor_images() {
      if (
        ...
        objNext = new Image();
        objNext.src =
          settings.imageArray[settings.activeImage + 1][0];
      }
      if (settings.activeImage > 0) {
        objPrev = new Image();
        objPrev.src =
